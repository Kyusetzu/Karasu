...
src-tauri/src/
  commands/          92 of the 105 frontend-facing commands, by subject:
                     auth · images · list · playback · prefs · system ·
                     update. The other 13 are the library scanner's, in
                     `library.rs`.
  ...
  gen/android/       generated by `tauri android init` and REGENERATED by it:
                     four files are hand-edited and say so in comments —
                     ...
                     won't recreate it: restore from git). Re-apply them
                     after any re-init. Also committed here: the bundled copy
