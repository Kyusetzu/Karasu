...
export const de: typeof en = {
  ...
  syncPanel: {
    ...
    sources: "Anfragen nach Quelle",
    sourcesEmpty: "In dieser Sitzung noch nichts gezählt.",
    throttled429: "Von AniList gebremst: {{n}}×",
  ...
  notif: {
    ...
    source: "Anzeigen",
    sourceAll: "Alle",
    emptySource: "Nichts aus dieser Quelle.",
    pageHint: "Karasus eigene Hinweise und die von AniList in einem Strom.",
    now: "jetzt",
    groupLikes: "gefällt {{n}} deiner Aktivitäten",
    groupReplyLikes: "gefällt {{n}} deiner Antworten",
    groupReplies: "hat auf {{n}} deiner Aktivitäten geantwortet",
    groupAiring: "{{n}} neue Folgen sind erschienen",
  ...
  keys: {
    ...
    zoomIn: "Oberfläche größer",
    zoomOut: "Oberfläche kleiner",
    zoomReset: "Oberfläche zurück auf 100 %",
  ...
  composer: {
    ...
    code: "Code",
    link: "Link",
    image: "Bild — img(url), oder img220(url) für eine Breite",
    video: "YouTube-Video — youtube(url)",
    center: "Zentrieren",
  },
  confirm: {
  ...
  stats: {
    ...
    sectionsLabel: "Statistikbereiche",
    hours: "{{n}} Std",
    chaptersShort: "{{n}} Kap.",
  ...
  about: {
    ...
    apkDownloading: "Lade {{version}} — {{received}} von {{total}} MB",
    apkInstall: "{{version}} installieren",
    apkNeedsPermission:
      "Android braucht deine Erlaubnis, damit Karasu Updates installieren darf: ein Schalter, „Unbekannte Apps installieren“, nur für diese App.",
    apkAllowInstall: "Installation erlauben",
    apkPlayProtectHint: "Play Protect fragt vielleicht noch einmal; die Datei wurde vorher gegen die Prüfsumme des Releases geprüft.",
    apkBlockedMetered: "{{version}} wartet auf WLAN. Über mobile Daten kostet der Download etwa 23 MB.",
    apkDownloadAnyway: "Trotzdem laden",
    apkBlockedSpace: "Nicht genug freier Speicher, um {{version}} zu laden und zu installieren.",
    apkBlockedSignature:
      "Das Release ist anders signiert als diese Installation und kann sie nicht aktualisieren — bitte von Hand von der Release-Seite installieren.",
    apkBlockedNetwork: "Der Download von {{version}} ist abgebrochen.",
    apkRetry: "Erneut versuchen",
  ...
  list: {
    ...
    filters: "Filter",
    filtersActive: "Filter, {{n}} aktiv",
    activeFilters: "Aktive Filter",
    removeFilter: "Filter {{name}} entfernen",
    resetFilters: "Zurücksetzen",
    filterTags: "Tags durchsuchen …",
    matchCount: "{{shown}} von {{total}}",
    matchTitles: "{{shown}} von {{total}} Titeln",
  ...
  detail: {
    ...
    scoreBarsHint: "Tippe auf einen Balken, um zu bewerten. Die Balken zeigen, wie alle anderen bewertet haben.",
    moreAnime: "Mehr · Rewatches, Tags, Notizen",
    moreManga: "Mehr · Rereads, Tags, Notizen",
    quickSaveHint: "Status, Fortschritt und Wertung werden sofort gespeichert, mit Rückgängig.",
    addToList: "Zur Liste hinzufügen",
  ...
  wrapped: {
    ...
    noneThisSeason: "Nichts aus dieser Saison abgeschlossen.",
    modeYear: "Jahr",
    modeSeason: "Saison",
    save: "Bild speichern",
  ...
  social: {
    ...
    threadsComments: "Kommentare",
    noThreadsCreated: "{{name}} hat noch keinen Thread erstellt",
    noUserComments: "{{name}} hat noch nichts im Forum geschrieben",
    ...
    favKindsLabel: "Art der Favoriten",
  ...
  settings: {
    ...
    title: "Einstellungen",
    pane_account: "Konto",
    paneHint_account: "Anmeldung, Listen, Profil, Benachrichtigungen",
    paneHint_appearance: "Sprache, Design, Akzent, Inhaltsfilter",
    paneHint_detection: "Scrobbeln, Benachrichtigungen, Mediensitzungen, Jellyfin",
    paneHint_library: "Ordner und Zuordnungen",
    ...
    groupLanguage: "Sprache & Bewegung",
    groupAniList: "Auf AniList gespeichert",
    ...
    accentSystemUnavailable: "Dieses System stellt keine Akzentfarbe bereit.",
    listDefaults: "Listen",
    ...
    density: "Dichte",
    densityHint:
      "Wie weit die dichten Ansichten auseinanderrücken: Kalender und lokale Bibliothek. Der Rest der App behält seine Größe.",
    ...
    apkMetered: "Updates über mobile Daten laden",
