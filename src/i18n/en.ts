...
export const en = {
  ...
  syncPanel: {
    ...
    sourcesEmpty: "Nothing counted yet this session.",
    throttled429: "Rate limited by AniList: {{n}}×",
    paced: "+{{ms}} ms paced",
    tookMs: "{{ms}} ms",
    measured: "Measured",
  ...
  notif: {
    ...
    source: "Show",
    sourceAll: "All",
    emptySource: "Nothing from this source.",
    pageHint: "Karasu's own notices and AniList's, in one stream.",
    now: "now",
  ...
  keys: {
    ...
    zoomIn: "Larger interface",
    zoomOut: "Smaller interface",
    zoomReset: "Interface back to 100 %",
    ...
    findInList: "Search this list",
    inComposer: "In a text box",
    bold: "Bold",
    italic: "Italic",
  ...
  composer: {
    ...
    code: "Code",
    link: "Link",
    image: "Image — img(url), or img220(url) for a width",
  ...
  stats: {
    ...
    sectionsLabel: "Statistics sections",
    hours: "{{n}} h",
    chaptersShort: "{{n}} ch",
  ...
  list: {
    ...
    resetFilters: "Reset",
    filterTags: "Search tags …",
    matchCount: "{{shown}} of {{total}}",
    matchTitles: "{{shown}} of {{total}} titles",
  ...
  palette: {
    ...
    hintMove: "↑↓ navigate",
    hintRun: "↵ open",
    keyClose: "Close the palette",
    hintClose: "Ctrl K close",
    typeHint: "Type to find pages, commands and titles.",
  },
  detail: {
    ...
    scoreBarsHint: "Tap a bar to score. The bars show how everyone else scored it.",
    moreAnime: "More · rewatches, tags, notes",
    moreManga: "More · rereads, tags, notes",
    quickSaveHint: "Status, progress and score save as you change them, with Undo.",
    addToList: "Add to list",
  ...
  social: {
    ...
    favKindsLabel: "Kind of favourite",
  ...
  settings: {
    ...
    paneHint_account: "Sign-in, lists, profile, notifications",
    paneHint_appearance: "Language, theme, accent, content filter",
    paneHint_detection: "Scrobbling, notifications, media sessions, Jellyfin",
    paneHint_library: "Folders and matches",
    ...
    groupLanguage: "Language & motion",
    groupAniList: "Kept on AniList",
    ...
    accentSystemUnavailable: "This system does not publish an accent colour.",
    listDefaults: "Lists",
    ...
    density: "Density",
    densityHint:
      "How much the dense screens spread out: the calendar and the local library. The rest of the app keeps its size.",
